...
// funcs.image_unload = '  pntr_image_unload(image);'
// funcs.subimage = '  pntr_subimage(image, x, y, width, height);'
...
// funcs.clear = '  pntr_clear(destination, color);'
...
// funcs.font_copy = '  pntr_font_copy(font);'
// funcs.font_load_bmf = '  pntr_font_load_bmf(filename, characters);'
// funcs.font_load_bmf_from_image = '  pntr_font_load_bmf_from_image(image, characters);'
// funcs.font_load_ttf = '  pntr_font_load_ttf(filename, fontSize);'
// funcs.font_load_tty = '  pntr_font_load_tty(filename, glyphWidth, glyphHeight, characters);'
// funcs.font_load_tty_from_image = '  pntr_font_load_tty_from_image(image, glyphWidth, glyphHeight, characters);'
// funcs.font_scale = '  pntr_font_scale(font, scaleX, scaleY, filter);'
// funcs.font_unload = '  pntr_font_unload(font);'
// funcs.text_measure = '  pntr_text_measure(font, text);'

// funcs.gamepad_button_down = '  pntr_gamepad_button_down(gamepad, button);'
// funcs.gamepad_button_pressed = '  pntr_gamepad_button_pressed(gamepad, button);'
// funcs.gamepad_button_released = '  pntr_gamepad_button_released(gamepad, button);'
// funcs.key_down = '  pntr_key_down(key);'
// funcs.key_pressed = '  pntr_key_pressed(key);'
// funcs.key_released = '  pntr_key_released(key);'
// funcs.key_up = '  pntr_key_up(key);'
// funcs.mouse_button_down = '  pntr_mouse_button_down(button);'
// funcs.mouse_button_pressed = '  pntr_mouse_button_pressed(button);'
// funcs.mouse_button_released = '  pntr_mouse_button_released(button);'
// funcs.mouse_button_up = '  pntr_mouse_button_up(button);'
// funcs.mouse_position = '  pntr_mouse_position();'
